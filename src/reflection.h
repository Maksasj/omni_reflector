...
#define OMNI_ADAPT_STRUCTURE_8_NAME(_NAMESPACE, _TYPE, _field1, _field2, _field3, _field4, _field5, _field6, _field7, _field8)\
template<>																	                \
struct omni::reflector::Reflection<_NAMESPACE::_TYPE> {									                \
    OMNI_TYPE_NAME_INFO_NAME(_NAMESPACE, _TYPE)                                                              \
    const constexpr static auto meta = std::make_tuple(						                \
        ...
        omni::reflector::FieldFriendlyScope::field_registration(&_NAMESPACE::_TYPE::_field6, #_field6),	\
        omni::reflector::FieldFriendlyScope::field_registration(&_NAMESPACE::_TYPE::_field7, #_field7),	\
        omni::reflector::FieldFriendlyScope::field_registration(&_NAMESPACE::_TYPE::_field8, #_field8)	\
    );																		                \
};	

#define OMNI_ADAPT_STRUCTURE_9_NAME(_NAMESPACE, _TYPE, _field1, _field2, _field3, _field4, _field5, _field6, _field7, _field8, _field9)\
template<>																	                \
struct omni::reflector::Reflection<_NAMESPACE::_TYPE> {									                \
    OMNI_TYPE_NAME_INFO_NAME(_NAMESPACE, _TYPE)                                                              \
    const constexpr static auto meta = std::make_tuple(						                \
        ...
        omni::reflector::FieldFriendlyScope::field_registration(&_NAMESPACE::_TYPE::_field7, #_field7),	\
        omni::reflector::FieldFriendlyScope::field_registration(&_NAMESPACE::_TYPE::_field8, #_field8),	\
        omni::reflector::FieldFriendlyScope::field_registration(&_NAMESPACE::_TYPE::_field9, #_field9)	\
    );																		                \
};	
...
#define OMNI_ADAPT_STRUCTURE_NAME(...) OMNI_GET_MACRO_NAME(__VA_ARGS__, OMNI_ADAPT_STRUCTURE_9_NAME, OMNI_ADAPT_STRUCTURE_8_NAME, OMNI_ADAPT_STRUCTURE_7_NAME, OMNI_ADAPT_STRUCTURE_6_NAME, OMNI_ADAPT_STRUCTURE_5_NAME, OMNI_ADAPT_STRUCTURE_4_NAME, OMNI_ADAPT_STRUCTURE_3_NAME, OMNI_ADAPT_STRUCTURE_2_NAME, OMNI_ADAPT_STRUCTURE_1_NAME, OMNI_ADAPT_STRUCTURE_0_NAME)(__VA_ARGS__)
#define OMNI_GET_MACRO_NAME(_0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, NAME, ...) NAME
